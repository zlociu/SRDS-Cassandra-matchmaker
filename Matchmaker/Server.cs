public record Server
{
    ...
    public static string CreateTableString => "CREATE TABLE IF NOT EXISTS Servers (id uuid, status text, region int, gametype int, maxplayers int, PRIMARY KEY ((gametype, region), id))";
